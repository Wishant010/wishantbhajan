        ...
        <div className="max-w-7xl mx-auto">
            ...
            <>
              ...
              {(project.projectData?.problem || project.projectData?.solution) && (
                <section className="mb-20">
                  <h2 className="section-title text-4xl font-bold text-white mb-12">The Challenge & Solution</h2>
              ...
              {project.projectData?.features && project.projectData.features.length > 0 && (
                <section className="mb-20">
                  <h2 className="section-title text-4xl font-bold text-white mb-12">Key Features</h2>
              ...
              {project.projectData?.techStack && (
                <section className="mb-20">
                  <h2 className="section-title text-4xl font-bold text-white mb-12">Technology Stack</h2>
                    ...
                    {project.projectData.techStack.architecture && (
                      <div className="p-8 rounded-2xl bg-gradient-to-br from-amber-950/30 to-amber-900/10 border border-amber-500/20">
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <h3 className="text-xl font-bold text-amber-400">Architecture</h3>
                        </div>
                        <div className="space-y-2">
              ...
              {project.projectData?.architecture && (
                <section className="mb-20">
                  <h2 className="section-title text-4xl font-bold text-white mb-12">System Architecture</h2>
                  <motion.div
              ...
              {(project.projectData?.challenges || project.projectData?.learnings) && (
                <section className="mb-20">
                  <h2 className="section-title text-4xl font-bold text-white mb-12">Challenges & Learnings</h2>
                  <div className="grid md:grid-cols-2 gap-8">
                    {project.projectData.challenges && project.projectData.challenges.length > 0 && (
                      ...
                      >
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <h3 className="text-2xl font-bold text-amber-400">Key Challenges</h3>
                        </div>
                    ...
                    {project.projectData.learnings && project.projectData.learnings.length > 0 && (
                      ...
                      >
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <h3 className="text-2xl font-bold text-emerald-400">What I Learned</h3>
                        </div>
                        <ul className="space-y-3">
          ...
          >
            <div className="border-t border-slate-800 pt-12">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">Explore More Projects</h2>
